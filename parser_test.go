...
func TestParseTypeOverrides(t *testing.T) {
	...
	p := New(SetOverrides(map[string]string{
		"github.com/daulet140/swag/testdata/global_override/types.Application":  "string",
		"github.com/daulet140/swag/testdata/global_override/types.Application2": "github.com/daulet140/swag/testdata/global_override/othertypes.Application",
		"github.com/daulet140/swag/testdata/global_override/types.ShouldSkip":   "",
	}))
	err := p.ParseAPI(searchDir, mainAPIFile, defaultParseDepth)
	assert.NoError(t, err)
...
func TestParser_skipPackageByPrefix(t *testing.T) {
	...
	assert.False(t, parser.skipPackageByPrefix("github.com/daulet140/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/daulet140/swag/cmd"))
	assert.False(t, parser.skipPackageByPrefix("github.com/daulet140/swag/gen"))

	parser = New(SetPackagePrefix("github.com/daulet140/swag/cmd"))

	assert.True(t, parser.skipPackageByPrefix("github.com/daulet140/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/daulet140/swag/cmd"))
	assert.True(t, parser.skipPackageByPrefix("github.com/daulet140/swag/gen"))

	parser = New(SetPackagePrefix("github.com/daulet140/swag/cmd,github.com/daulet140/swag/gen"))
